package com.killer.sample.spring.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.killer.sample.spring.repositories",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[]{ "com.killer.sample.spring.model" });
